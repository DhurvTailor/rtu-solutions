...
//   name: "Colleges",
//   path: "/admin/colleges",
//   icon: <FiHome size={20} />,   // ya alag icon, FiHome already Dashboard mein use ho raha hai to clash hoga — main FiMapPin ya kuch aur dunga
// },
// {
//   name: "Training Companies",
//   path: "/admin/training-companies",
//   icon: <FiBriefcase size={20} />,
// },
// {
//   name: "Report Templates",
//   path: "/admin/report-templates",
//   icon: <FiFileText size={20} />,   // ye already Solutions mein use ho raha hai
// },
// {
...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className={`h-screen sticky top-0 bg-linear-to-b from-[#071A3D] via-[#0d234d] to-[#142647]
      border-r border-white/10 shadow-2xl transition-all duration-300 overflow-y-auto
      ${collapsed ? "w-20" : "w-72"}`}
    >
      {/* Header */}
      <div className="h-20 flex items-center justify-between px-5 border-b border-white/10 sticky top-0 bg-[#071A3D] z-10">
        {!collapsed && (
          <div>
            <h2 className="text-white font-bold text-2xl">
              RTU Admin
