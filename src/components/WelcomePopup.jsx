      ...
      >
        ...
        >
          ...
          <div className="relative w-full">
            <Image
              src="/Free.webp"
              alt="New students get 2 PDF free"
              width={560}
              height={560}
            ...
            <button
              onClick={handleClose}
              className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-full bg-black/40 hover:bg-black/60 text-white transition"
            >
              <FaTimes size={13} />
            </button>
          </div>

          {/* ── Bottom section: greeting + CTA ── */}
          <div className="px-6 py-5">

            {/* Personalised greeting */}
            {firstName && (
              <p className="text-center text-[#071A3D] font-bold text-base mb-3">
                Welcome, {firstName}! 🎉
              </p>
            )}
