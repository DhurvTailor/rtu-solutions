...
//           {/* Breadcrumb of current selection - visible once user starts choosing */}
//           {hasPath && (
...
//         {/* Subjects - chips, wrap on all screens (no horizontal scroll needed) */}
//         {semester && (
//           <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 mb-5">
//             <div className="mb-3 flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-gray-400">
...
//                       </div>
//                       {sol.is_premium ? (
//                         <span className="shrink-0 inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-semibold bg-orange-50 text-[#E8700A] border border-[#E8700A]/20">
//                           Premium
//                         </span>
//                       ) : (
//                         <span className="shrink-0 inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-semibold bg-[#071A3D]/5 text-[#071A3D]">
//                           Free
//                         </span>
//                       )}
//                     </div>
...
//                         <td className="px-6 py-4">
//                           {sol.is_premium ? (
//                             <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-orange-50 text-[#E8700A] border border-[#E8700A]/20">
//                               Premium
//                             </span>
//                           ) : (
//                             <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-[#071A3D]/5 text-[#071A3D]">
//                               Free
//                             </span>
//                           )}
//                         </td>
