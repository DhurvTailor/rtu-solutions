      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-5 items-start">
          ...
          <div className="w-full lg:w-80 lg:shrink-0 space-y-4 lg:sticky lg:top-4">
            ...
            {/* ── NEW: clickable Watch Free Video button (only YouTube info box changed) ── */}
            {solution?.youtube_url && (
              <a
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-semibold text-gray-800">Watch Free Video</p>
                  <p className="text-xs text-gray-500">See video explanation on YouTube</p>
                </div>
                <span className="text-xs font-bold text-red-500 shrink-0">Watch ▶</span>
              </a>
            )}
