...
function renderDocxTemplate(templateBuffer, placeholderData) {
  ...
  try {
    ...
    const doc = new Docxtemplater(zip, {
      paragraphLoop: true,
      linebreaks: true,
      // Docxtemplater ka default delimiter hi single curly { } hai — jo
      // hamare templates ke format se match karta hai. Isko double curly
      // {{ }} par mat badlo jab tak templates khud double curly na ho.
      nullGetter: (part) => {
